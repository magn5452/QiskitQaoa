...
from VehicleRouting.standard.concretization.GraphStrategy import Experiment1GraphStrategy, Experiment2GraphStrategy, \
    TwoVertexExperimentGraphStrategy, ThreeVertexExperimentGraphStrategy
...
class ThreeVertexVehicleRoutingProblemFactory(VehicleRoutingProblemFactory):

    def create_graph_strategy(self) -> GraphStrategy:
        return ThreeVertexExperimentGraphStrategy()
